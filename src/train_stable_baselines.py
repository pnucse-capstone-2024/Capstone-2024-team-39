...
# from ev2gym.rl_agent.reward import SquaredTrackingErrorReward, ProfitMax_TrPenalty_UserIncentives
# from ev2gym.rl_agent.reward import EV_user_reward_function
from ev2gym.rl_agent.reward import CombinedRewardFunction_2 #SquaredCombinedRewardFunction
...
if __name__ == "__main__":
    ...
    #default="./example_config_files/V2GProfitPlusLoads.yaml")
    ...
    if config_file.endswith("V2GProfitMax.yaml"):
    ...
    elif config_file.endswith("PublicPST.yaml"):
        reward_function = SquaredTrackingErrorReward
        state_function = PublicPST
        group_name = f'{config["number_of_charging_stations"]}cs_PublicPST'
    elif config_file.endswith("V2GProfitPlusLoads.yaml"):
