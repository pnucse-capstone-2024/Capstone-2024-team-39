...
from ev2gym.rl_agent.reward import CombinedRewardFunction_2
from ev2gym.rl_agent.state import CombinedStateFunction

# from ev2gym.rl_agent.reward import CombinedRewardFunction, SquaredTrackingErrorReward, Grid_Operator_reward_function, EV_user_reward_function
# from ev2gym.rl_agent.reward import profit_maximization, ProfitMax_TrPenalty_UserIncentives
# from ev2gym.rl_agent.state import CombinedStateFunction, V2G_profit_max, PublicPST, V2G_profit_max_loads, EV_user_state_function
...
def evaluator():
    ...
    if args.config_file == "./example_config_files/V2GProfitMax.yaml":
        reward_function = CombinedRewardFunction_2
        state_function = CombinedStateFunction
        # reward_function = profit_maximization
        # state_function = V2G_profit_max

    elif args.config_file == "./example_config_files/PublicPST.yaml":
        reward_function = SquaredTrackingErrorReward
        state_function = PublicPST
        # reward_function = EV_user_reward_function
        # state_function = EV_user_state_function

    elif args.config_file == "./example_config_files/V2G_MPC.yaml":
        reward_function = profit_maximization
        state_function = V2G_profit_max

    elif args.config_file == "./example_config_files/V2GProfitPlusLoads.yaml":        
